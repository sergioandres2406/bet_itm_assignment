...
/*  VISTA 1 */
CREATE OR REPLACE VIEW V_GANADORES_SEMANALES 
...
CREATE OR REPLACE VIEW V_DETALLES_APUESTAS
AS
...
CREATE OR REPLACE VIEW V_RESUMEN_APUESTAS
AS
SELECT ID_APUESTA ID ,COUNT (*) NUMERO_APUESTAS, SUM(valor_apostado) TOTAL_VALOR_APOSTADO, 
